...
function SubSidebarLink({ to, icon: Icon, label }) {
  ...
  const isInfoActive = to === "/producer/edit-profile" && location.pathname === "/producer/edit-profile";
  const finalIsActive = (to === "/producer/edit-profile") ? isInfoActive : isActive;
  ...
  return (
    <div className={styles.layoutContainer}>
      ...
      <aside className={styles.mainSidebar}>
        ...
        <MainSidebarLink to="/producer/dashboard" icon={Squares2X2Icon} label="DASHBOARD" />
        <MainSidebarLink to="/producer/edit-profile" icon={PencilIcon} label="EDITAR PERFIL" />
        ...
        <div className={styles.contentBox}>
          ...
          <nav className={styles.subSidebar}>
            ...
            <ul className={styles.subLinkList}>
              ...
              <li>
                <SubSidebarLink 
                  to="/producer/edit-profile/security" 
                  icon={LockClosedIcon} 
                  label="LOGIN E SENHA" 
                />
              </li>
